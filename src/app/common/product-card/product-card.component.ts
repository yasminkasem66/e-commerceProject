...
export class ProductCardComponent implements OnInit {
  ...
  @Input('shoping_cart') shoping_cart: Cart = {} as Cart;
  defaultImg: string =
    'https://img.freepik.com/free-photo/assortment-bread-loaves-wood_23-2147761305.jpg?w=740&t=st=1675005083~exp=1675005683~hmac=1a3752887575eb1d935ff96e235408b8a8ef5b124c315043468c33d05ee1a9fe';
